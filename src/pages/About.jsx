  ...
  return (
    <div>
      ...
      <main>
        ...
        <FlexWrap>
          <InfoCard iconSrc="/icon-pin.png" title="Desarrollo profesional" body="Quiero seguir creciendo como desarrollador web fullstack, aprendiendo las mejores prácticas tanto de backend como de frontend. Me interesa estar siempre al día con las últimas tecnologías y seguir capacitándome para ser un profesional más completo. Mi meta es poder crear soluciones innovadoras y aportar valor en cualquier proyecto en el que trabaje." />
          <InfoCard iconSrc="/icon-pin.png" title="Colaborar con otros developers" body="Me gustaría trabajar en equipo para aprender de otros profesionales, intercambiar ideas y llevar a cabo proyectos desafiantes juntos." />
        </FlexWrap>
      </main>
    </div>
  );
